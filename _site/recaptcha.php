    ...
    <div class="wrapper">
        ...
        <div class="content">
			...
			<?php require_once __DIR__ . '/php/recaptcha/autoload.php';				
				$siteKey = '6Le87DgUAAAAAAEOObGKwjgcEPpbj5p2BAqg-CIQ'; // visit https://www.google.com/recaptcha/admin to generate keys
				$secret = '6Le87DgUAAAAAE6mcjuk6i4CKkIuY0QXr4lJQbfr';
